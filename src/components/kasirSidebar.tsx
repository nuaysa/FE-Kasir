...
export default function SidebarKasir() {
  ...
  const navItems = [
      { name: "Dashboard", path: "/dashboard", icon: <RiDashboardLine size={24} /> },
    { name: "Transaksi", path: "/transaksi", icon: <PiCashRegisterBold size={24} /> },
    { name: "Produk", path: "/produk", icon: <FolderClock size={24} /> },
    { name: "stok", path: "/stok", icon: <FileText size={24} /> },
  ];
